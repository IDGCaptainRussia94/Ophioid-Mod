...
namespace OphioidMod.Tiles
{
	...
	public class BossRelics : ModTile
	{
		...
		public const int VerticalFrames = 2; // Optional: Increase this number to match the amount of relics you have on your extra sheet, if you choose to go the Item.placeStyle way
		...
		public virtual string RelicTextureName => "OphioidMod/Tiles/Relics";
